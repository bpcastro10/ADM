...
SYSTEM_PROMPT_WRITTEN = (
    ...
    "- 3-10 criterios según el contenido; criterion_name = área/pregunta evaluada.\n"
...
SYSTEM_PROMPT_NOTEBOOK = (
    ...
    "- 3-10 criterios basados en las instrucciones; criterion_name = aspecto evaluado.\n"
...
JSON (3-10 criterios; overall_score coherente; 2-4 strengths/improvements):
{json_schema}"""
...
def _call_ai(system: str, user: str, max_tokens: int = _MAX_TOKENS_EVAL) -> str:
...
def evaluate_written_test(document_text: str) -> AIEvaluationResponse:
    ...
    raw = _call_ai(SYSTEM_PROMPT_WRITTEN, user_prompt)
    parsed = _parse_ai_response(raw)
...
def evaluate_notebook(
    ...
    raw = _call_ai(SYSTEM_PROMPT_NOTEBOOK, user_prompt)
    parsed = _parse_ai_response(raw)
