      ...
      <div className="layout">
        <div className="stack">
          ...
          {activeTab === 'code' && (
            <CodeEvaluationTab
              ...
              documentFile2={codeEval.documentFile2}
              onDocumentFile2Change={codeEval.handleDocumentFile2Change}
              onClearDocumentFile2={codeEval.clearDocumentFile2}
              ...
              notebookFile2={codeEval.notebookFile2}
              onNotebookFile2Change={codeEval.handleNotebookFile2Change}
              onClearNotebookFile2={codeEval.clearNotebookFile2}
              ...
              codeSubResult={codeEval.codeSubResult}
              writtenSubResult={codeEval.writtenSubResult}
              notebookSubResult={codeEval.notebookSubResult}
        ...
        <div className="stack sticky">
          ...
          {activeTab === 'cv' && (
            <CvResultPanel
              resumeResult={resumeEval.resumeResult}
              hasCodeResult={Boolean(codeEval.techResult)}
              resumeLoading={resumeEval.resumeLoading}
              loading={codeEval.loading}
              onDownloadResumePdf={resumeEval.downloadResumePdf}
              onDownloadUnifiedPdf={combined.downloadUnifiedPdf}
