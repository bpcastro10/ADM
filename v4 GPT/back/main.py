...
from services.ai_client import get_ai_status, is_ai_configured
...
app = FastAPI(
    ...
    description="API para evaluar candidatos usando IA según rúbricas personalizadas.",
    version="1.0.0",
)
...
async def evaluate(request: EvaluationRequest):
    ...
    if not is_ai_configured():
        raise HTTPException(
            status_code=503,
            detail="El servicio de IA no está configurado. Configure Azure OpenAI o ANTHROPIC_API_KEY.",
        )
