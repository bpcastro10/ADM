...
# Escala genérica — aplica a cualquier tipo de puesto o prueba.
...
# Plantillas específicas por lenguaje/tecnología (desarrollo de software)
_SCORE_SCALE_TEMPLATES: dict[str, dict[str, str]] = {
    ...
    # Plantillas para roles no técnicos
    "text": {
...
def suggest_score_scale(
    *,
    ...
    """Plantilla pertinente al crear o completar una rúbrica."""
